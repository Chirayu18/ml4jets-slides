...
difference $\sim7\times10^{-8}$ --- float32 precision.}
\end{column}
\begin{column}{0.45\textwidth}
...
{\small Speedups are quoted against the \textbf{vectorised} FastJet
...
over vectorised FastJet (median \textbf{89$\times$}),
every point at \textbf{100\,\%} $n_{\rm jets}$ agreement. }
\end{frame}
...
%TODO: Clip the tbqq panel and center the plot making it bigger and all. and center the right column also
\begin{columns}[T]
\begin{column}{0.68\textwidth}
\includegraphics[width=\linewidth]{fig/part_ratio_allclasses.png}\\[-0.4em]
\end{column}
...
\scriptsize An \textbf{early gain in every class}, \textbf{gone by 1\,M}.  At convergence:
\textbf{null-or-worse}.
\end{block}
\end{column}
\end{columns}
