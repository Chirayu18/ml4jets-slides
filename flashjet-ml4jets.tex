...
\end{tabular}
\end{center}
%TODO decrease font size in table slightly to make table fit and add another column explaining the 3 plots above
\end{frame}
...
\end{tabular}
\end{center}
%TODO show a bracket around the bottom 3 rows and arrow that to a actual binary tree output by flashjet
\begin{center}
\end{center}
\end{frame}

\begin{frame}{What is implemented}
%TODO make this more like a transition slide keep content same
\begin{columns}[T]
...
\vspace{-0.5em}
\hspace{-0.5em}
\includegraphics[width=\linewidth]{fig/tree_gallery.png}
\end{center}
%TODO make this plot bigger somehow if possible
\end{frame}
