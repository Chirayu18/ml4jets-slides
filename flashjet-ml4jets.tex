...
\begin{itemize}\setlength\itemsep{0.1em}
  ...
  \item $\sim$\textbf{30\,\%} of HLT reco offloaded $\rightarrow$
        $\sim$\textbf{40\,\%} less HLT time
\end{itemize}
\vspace{0.4em}
%TODO add image.png and cite https://www.epj-conferences.org/articles/epjconf/pdf/2024/05/epjconf_chep2024_11020.pdf
...
Inside a training loop, we pay for transferring data from host to device and back for: 
\begin{itemize}\setlength\itemsep{0.1em}
...
batched. The same method is applied to whole events ($\sim$590 clusters) on the
next slide.}
\end{column}
\end{columns}
\end{frame}
